...
class AgregarTarjeta3 extends StatefulWidget {
  @override
  _AgregarTarjeta3 createState() => _AgregarTarjeta3();
}

class _AgregarTarjeta3 extends State<AgregarTarjeta3> {
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Add Credit Card",
          style: TextStyle(
              fontFamily: "ExtraBoldFont", fontSize: 20.0, color: Colors.white),
        ),
      ),
      body: SafeArea(
