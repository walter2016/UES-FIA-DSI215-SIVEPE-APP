  ...
  OrderList() {
    this._list = [
      ...
      new Order(
          ...
          OrderState.unpaid),
      new Order(
          new Product('Robe pin up', 'assets/images/bag_1.png', 10, 12.36, 153,
              166, 4.2, 11.5),
          'CH456124566652',
          OrderState.shipped),
    ];
